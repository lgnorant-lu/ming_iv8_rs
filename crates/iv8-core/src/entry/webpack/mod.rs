...
fn detect_chunks(kernel: &mut EmbeddedV8Kernel) -> Vec<serde_json::Value> {
    let js = concat!(
        ...
        "  }",
        "}",
        // webpack 5: webpackChunk OR webpackChunk{output.uniqueName}
        "function scanWpc(wpc, state){",
        "  if (!wpc || !Array.isArray(wpc)) return;",
        "  for (var cj = 0; cj < wpc.length; cj++) {",
        "    var ent = wpc[cj];",
        "    if (ent && Array.isArray(ent) && ent[0] != null) {",
        "      pushChunk(ent[0], ent[1], state);",
        "    }",
        "  }",
        "}",
        "function eachWebpackChunk(fn){",
        "  var roots = [];",
        "  try { if (typeof self !== 'undefined') roots.push(self); } catch(e) {}",
        "  try { if (typeof window !== 'undefined') roots.push(window); } catch(e) {}",
        ...
        "    try {",
        "      if (root.webpackChunk && !seen['webpackChunk']) {",
        "        seen['webpackChunk'] = 1; fn(root.webpackChunk);",
        "      }",
        "      var keys = Object.keys(root);",
        "      for (var ki = 0; ki < keys.length; ki++) {",
        "        var k = keys[ki];",
        "        if (k.indexOf('webpackChunk') === 0 && !seen[k]) {",
        "          seen[k] = 1; fn(root[k]);",
        "        }",
        "      }",
        "    } catch(e) {}",
        "  }",
        "}",
        "eachWebpackChunk(function(wpc){ scanWpc(wpc, 'loaded'); });",
        "return result;",
        "})()"
    );
    match kernel.eval_to_rust_value(js) {
...
pub fn collect_module_graph(kernel: &mut EmbeddedV8Kernel) -> Option<serde_json::Value> {
    ...
    // Merge module IDs from webpackJsonp / webpackChunk tables (multi-chunk).
    {
        let js = concat!(
            ...
            "  var seen={};",
            "  for(var ri=0;ri<roots.length;ri++){",
            "    var root=roots[ri]; if(!root||typeof root!=='object')continue;",
            "    try{",
            "      if(root.webpackChunk&&!seen.webpackChunk){seen.webpackChunk=1;fn(root.webpackChunk);}",
            "      var keys=Object.keys(root);",
            "      for(var ki=0;ki<keys.length;ki++){",
            "        var k=keys[ki];",
            "        if(k.indexOf('webpackChunk')===0&&!seen[k]){seen[k]=1;fn(root[k]);}",
            "      }",
            "    }catch(e){}",
            "  }",
            "}",
        ...
        std::collections::HashMap::new();
    {
        let js = concat!(
            ...
            "  for(var ri=0;ri<roots.length;ri++){",
            "    var root=roots[ri]; if(!root||typeof root!=='object')continue;",
            "    if(root.webpackChunk&&!seen.webpackChunk){seen.webpackChunk=1;scan(root.webpackChunk);}",
            "    var keys=Object.keys(root);",
            "    for(var ki=0;ki<keys.length;ki++){",
            "      var k=keys[ki];",
            "      if(k.indexOf('webpackChunk')===0&&!seen[k]){seen[k]=1;scan(root[k]);}",
            "    }",
            "  }",
            "}catch(e){}",
            "return map;",
