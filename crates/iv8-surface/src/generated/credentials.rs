...
pub fn create_authenticator_assertion_response_template<'s>(
    ...
    // attribute: authenticatorData
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(authenticator_assertion_response_get_1).build(scope);
        proto.set_accessor_property(name.into(), Some(getter), None, v8::PropertyAttribute::NONE);
    }
    // attribute: signature
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(authenticator_assertion_response_get_2).build(scope);
        proto.set_accessor_property(name.into(), Some(getter), None, v8::PropertyAttribute::NONE);
    }
    // attribute: userHandle
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(authenticator_assertion_response_get_3).build(scope);
        proto.set_accessor_property(name.into(), Some(getter), None, v8::PropertyAttribute::NONE);
    }
...
unsafe extern "C" fn authenticator_attestation_response_get_1(
...
unsafe extern "C" fn authenticator_attestation_response_op_2(
    info: *const v8::FunctionCallbackInfo,
) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let info_ref = unsafe { &*info };
...
unsafe extern "C" fn authenticator_attestation_response_op_3(
    info: *const v8::FunctionCallbackInfo,
) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let info_ref = unsafe { &*info };
...
unsafe extern "C" fn authenticator_attestation_response_op_4(
    info: *const v8::FunctionCallbackInfo,
) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let info_ref = unsafe { &*info };
...
unsafe extern "C" fn authenticator_attestation_response_op_5(
    info: *const v8::FunctionCallbackInfo,
) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let info_ref = unsafe { &*info };
...
pub fn create_authenticator_attestation_response_template<'s>(
    ...
    // attribute: attestationObject
    {
        ...
        let getter = v8::FunctionTemplate::builder_raw(authenticator_attestation_response_get_1)
            .build(scope);
        proto.set_accessor_property(name.into(), Some(getter), None, v8::PropertyAttribute::NONE);
    }
    // method: getTransports()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(authenticator_attestation_response_op_2).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: getAuthenticatorData()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(authenticator_attestation_response_op_3).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: getPublicKey()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(authenticator_attestation_response_op_4).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: getPublicKeyAlgorithm()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(authenticator_attestation_response_op_5).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
