...
pub(crate) unsafe extern "C" fn gpu_buffer_get_3(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUBufferMapState").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_compilation_message_get_2(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUCompilationMessageType").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_device_lost_info_get_1(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUDeviceLostReason").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_query_set_get_2(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUQueryType").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_texture_get_8(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUTextureDimension").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_texture_get_9(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUTextureFormat").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_texture_get_11(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUTextureViewDimension").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
...
pub(crate) unsafe extern "C" fn gpu_pipeline_error_get_1(_info: *const v8::FunctionCallbackInfo) {
    let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        {
            let __ctor_name = v8::String::new(scope, "GPUPipelineErrorReason").unwrap();
            let __ctx = scope.get_current_context();
            let __global = __ctx.global(scope);
            if let Some(__ctor) = __global.get(scope, __ctor_name.into()) {
                if __ctor.is_object() {
