...
pub fn create_presentation_availability_template<'s>(
    ...
    // attribute: value
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(presentation_availability_get_1).build(scope);
        proto.set_accessor_property(name.into(), Some(getter), None, v8::PropertyAttribute::NONE);
    }
    // attribute: onchange
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(presentation_availability_get_2).build(scope);
        let setter =
            v8::FunctionTemplate::builder_raw(presentation_availability_set_2).build(scope);
        proto.set_accessor_property(
            name.into(),
            Some(getter),
            Some(setter),
...
pub fn create_presentation_connection_template<'s>(
    ...
    // method: close()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(presentation_connection_op_4).build(scope);
    ...
    // method: terminate()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(presentation_connection_op_5).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // attribute: onconnect
    ...
    // method: send()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(presentation_connection_op_11).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: send()
    {
        let name = v8::String::new(scope, "send").unwrap();
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(presentation_connection_op_12).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: send()
    {
        let name = v8::String::new(scope, "send").unwrap();
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(presentation_connection_op_13).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: send()
    {
        let name = v8::String::new(scope, "send").unwrap();
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(presentation_connection_op_14).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
...
pub fn create_presentation_connection_list_template<'s>(
    ...
    // attribute: connections
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(presentation_connection_list_get_1).build(scope);
        proto.set_accessor_property(name.into(), Some(getter), None, v8::PropertyAttribute::NONE);
    }
    // attribute: onconnectionavailable
    {
        ...
        let getter =
            v8::FunctionTemplate::builder_raw(presentation_connection_list_get_2).build(scope);
        let setter =
            v8::FunctionTemplate::builder_raw(presentation_connection_list_set_2).build(scope);
        proto.set_accessor_property(
            name.into(),
            Some(getter),
            Some(setter),
