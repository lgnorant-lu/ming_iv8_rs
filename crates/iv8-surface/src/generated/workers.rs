...
pub fn create_service_worker_container_template<'s>(
    ...
    // method: register()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(service_worker_container_op_3).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
...
pub fn create_service_worker_registration_template<'s>(
    ...
    // method: showNotification()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(service_worker_registration_op_14).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
