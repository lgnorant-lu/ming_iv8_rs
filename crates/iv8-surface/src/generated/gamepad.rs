...
pub fn create_gamepad_haptic_actuator_template<'s>(
    ...
    // method: playEffect()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(gamepad_haptic_actuator_op_2).build(scope);
    ...
    // method: reset()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(gamepad_haptic_actuator_op_3).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: pulse()
    {
        ...
        let func_tmpl =
            v8::FunctionTemplate::builder_raw(gamepad_haptic_actuator_op_4).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
