...
EXC_TESTS = [
    ...
    ("document.createElement('div').getAttribute(null)", "TypeError"),
    ("document.getElementById(null)", "TypeError"),
    ("document.querySelectorAll(null)", "TypeError"),
    ("document.querySelectorAll()", "TypeError"),
    ("new Event()", "TypeError"),
    ("new Event(null)", "TypeError"),
    ("Event()", "TypeError"),
    ("new CustomEvent()", "TypeError"),
    ("new MouseEvent()", "TypeError"),
    ("new URL(null)", "TypeError"),
    ("new URL()", "TypeError"),
    ("new URLSearchParams(null)", "TypeError"),
