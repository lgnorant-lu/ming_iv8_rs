...
- **Native Substrate Mainline (v0.8.17-v0.8.22)**: Navigator/Screen FunctionTemplate migration (descriptor.m1 184/184, fingerprint.m1 322/322), IDL preprocessing toolchain (unified_ir.json 5645KB 2913 defs), Rust codegen + iv8-surface crate (~128K lines 1284 interfaces), BrowserSurface integration + Feature Flag, P0 deep stubs (Canvas2D/WebGL/Location/Navigator/SubtleCrypto), P1 deep stubs (Document/createElement/classList/style/Fetch/XHR/DOMRect with 179/179 core tests + 30/30 surface tests)
