...
**Current**: v0.8.90 (North Star Phase 1: Event/Audio shim preserve codegen prototype + K-018 WPT panic fix + K-016 post-hoc tracing + H05b/c/H06a harness) — [Progress](docs/PROGRESS.md)
