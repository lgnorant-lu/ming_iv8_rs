...
- **L2 Convergence Event + Reproducible Snapshot (v0.8.34)**: `tools/convergence/` event/snapshot/delta/knowledge-index helpers, source report adapters, additive MAPE-K snapshot/delta integration; 1367 Python PASS.
