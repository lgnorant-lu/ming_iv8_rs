...
**Current**: v0.8.87 (V8 error handlers + boundary fixes + crypto 15 algorithms + WPT coverage gap analysis + H05/H06/L4b TODO registration) — [Progress](docs/PROGRESS.md)
