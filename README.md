...
- **Native Substrate Mainline (v0.8.17-v0.8.24)**: Navigator/Screen FunctionTemplate migration (descriptor.m1 184/184, fingerprint.m1 322/322), IDL preprocessing toolchain (unified_ir.json 5645KB 2913 defs), Rust codegen + iv8-surface crate (~128K lines 1284 interfaces), BrowserSurface integration + Feature Flag, P0 deep stubs (Canvas2D/WebGL/Location/Navigator), P1 deep stubs (Document/createElement/classList/style/Fetch with 180/180 core tests + 30/30 surface tests), v0.8.23 infrastructure optimization (v8::Weak memory reduction, dead code cleanup, document_props.rs modularization), v0.8.25 BCR upgrade + behavior wiring; v0.8.24 Feature Flag removal + user_overrides (306 tests PASS). SubtleCrypto and full BrowserSurface activation pending v0.8.25+.

Current `0.8.11` package release scope is tracked in `docs/roadmap/post-v0.6/v0.8.11-environment-pressure-to-plan-bridge-plan.md`. v0.8.12-v0.8.24 are local milestones; package metadata remains `0.8.11`. Active mainline: [Native Substrate v0.8.18-v0.8.24 Roadmap](docs/roadmap/post-v0.6/v0.8.18-to-v0.8.24-roadmap.md). v0.9 holding track continuing blocked.
