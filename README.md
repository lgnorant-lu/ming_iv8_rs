...
- **Native Substrate Mainline (v0.8.17-v0.8.29)**: Navigator/Screen FunctionTemplate migration (descriptor.m1 184/184, fingerprint.m1 322/322), IDL preprocessing toolchain, Rust codegen + iv8-surface crate (1284 interfaces), BrowserSurface integration + Feature Flag removal, P0/P1 deep stubs (180+30 tests), infrastructure optimization, Feature Flag removal + user_overrides (v0.8.24), BCR upgrade + install_all Global-handle (v0.8.25), codegen scope-break + GC fix (v0.8.26), Phase C + archive (v0.8.27), verification closure + BCR Step A (v0.8.28), BCR Step B dispatch hub + L2 Stage 2 MVP (v0.8.29). 255/255 lib + 81 Phase C + 1296 Python + 12 L2 tests PASS. v0.9 holding track continuing blocked.
Current `0.8.11` package release scope. v0.8.12-v0.8.29 are local milestones; package metadata remains `0.8.11`. Active mainline: [Native Substrate](docs/roadmap/post-v0.6/EXECUTION_ORDER.md). v0.9 holding track continuing blocked.
