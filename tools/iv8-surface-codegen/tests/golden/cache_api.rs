...
pub fn create_cache_template<'s>(
    ...
    // method: match()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_op_1).build(scope);
    ...
    // method: add()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_op_3).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: addAll()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_op_4).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: put()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_op_5).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: delete()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_op_6).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: keys()
...
pub fn create_cache_storage_template<'s>(
    ...
    {
        let name = v8::String::new(scope, "match").unwrap();
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_storage_op_1).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: has()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_storage_op_2).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: open()
    {
        ...
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_storage_op_3).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: delete()
    {
        let name = v8::String::new(scope, "delete").unwrap();
        let func_tmpl = v8::FunctionTemplate::builder_raw(cache_storage_op_4).build(scope);
        func_tmpl.set_class_name(name);
        proto.set(name.into(), func_tmpl.into());
    }
    // method: keys()
